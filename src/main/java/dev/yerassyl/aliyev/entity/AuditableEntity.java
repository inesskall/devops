...
public abstract class AuditableEntity extends BaseEntity implements Serializable {
    ...
    @LastModifiedDate
    @Column(name = "last_modified_date",columnDefinition = "TIMESTAMP") // if (..., nullable = false) than org.hibernate.PropertyValueException: not-null property references a null or transient value : dev.yerassyl.aliyev.entity.Event.lastModifiedDate
